...
# ==== load model to test ====
model = Net()
model_path = "./nn_model/WBias_SN=4_epoch=10000_test_loss=1.0193.pkl"
...
# No SN
model = Net()
model_name = "bias0.686_SN=0_epoch=10000_test_loss=0.6185_model_params.pkl"
...
# SN=4
model = Net()
model_name = "bias0.686_SN=4_epoch=10000_test_loss=1.0523_model_params_best.pkl"
model.load_state_dict(torch.load("./nn_model/" + model_name))
# model.load_state_dict(torch.load("./model/model_params.pt"))
model.eval()
model.to("cuda")
...
# SN=2
model = Net()
model_name = "bias0.686_SN=2_epoch=10000_test_loss=1.6288_model_params.pkl"
model.load_state_dict(torch.load("./nn_model/" + model_name))
# model.load_state_dict(torch.load("./model/model_params.pt"))
model.eval()
model.to("cuda")
...
cbar_ax = fig.add_axes([0.88, 0.28, 0.020, 0.40])
